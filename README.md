...
Apply knowledge of Python and unsupervised learning to predict if cryptocurrencies are affected by 24-hour or 7-day price changes.
...
3. The first five rows of the scaled DataFrame should appear.
...
4. The first five rows of the PCA DataFrame should appear.
